...
class NoticiaController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Noticia']))
		{
            ...
            if ($model->validate()) {
                ...
                $imageWidthRequired = Yii::app()->params['fotoNoticiaDimensions']['width'];
                $imageHeightRequired = Yii::app()->params['fotoNoticiaDimensions']['height'];
    ...
    {
        return Yii::app()->basePath . '/../images/noticias/';
    }
	...
	public function actionIndex()
	{
        ...
        if (isset($_REQUEST['sSearch']) && isset($_REQUEST['sSearch']{0})) {
            ...
            Yii::app()->session['noticiaSearch'] = $_REQUEST['sSearch'];
        }
...
//        $criteria->order = 'id DESC';
        ...
        $sort = new EDTSort('Noticia', $columns);
...
//        $pagination->setPageSize(10);
        ...
        $widget = $this->createWidget('ext.nineinchnick.edatatables.EDataTables', array(
            ...
            'dataProvider' => $dataProvider,
            'ajaxUrl' => $this->createUrl('/noticia/index?a'),
            'columns' => $columns,

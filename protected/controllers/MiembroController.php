...
class MiembroController extends Controller
{
	...
	public function actionCreate()
	{
        ...
        if(isset($_POST['Miembro']))
        {
            ...
            if ($model->validate()) {
                ...
                $imageWidthRequired = Yii::app()->params['fotoBannerDimensions']['width']; //120x130
	...
	{
		/*$dataProvider=new CActiveDataProvider('Miembro');
        ...
        if (isset($_REQUEST['sSearch']) && isset($_REQUEST['sSearch']{0})) {
            ...
            Yii::app()->session['miembroSearch'] = $_REQUEST['sSearch'];
        }
...
//        $criteria->order = 'id DESC';
        ...
        $columns = array(
            ...
            array(
                ...
                'sortable' => true,
                'type' => 'raw',
                'value' => 'CHtml::image(Yii::app()->baseUrl . "/images/miembros/" . $data->imageUrl, "imagen", array("width" => 120, "height" => 130))',

            ),
            'posicion');

        $sort = new EDTSort('Miembro', $columns);
        $sort->defaultOrder = 'posicion';

        $pagination = new EDTPagination();
//        $pagination->setPageSize(10);

        $dataProvider = new CActiveDataProvider('Miembro', array(
            'criteria' => $criteria,
        ...
        $widget = $this->createWidget('ext.nineinchnick.edatatables.EDataTables', array(
            ...
            'dataProvider' => $dataProvider,
            'ajaxUrl' => $this->createUrl('/miembro/index?a'),
            'columns' => $columns,
...
//                'fnDrawCallbackCustom' => "js:function(){\$('a[rel=tooltip]').tooltip(); \$('a[rel=popover]').popover();}",
	 ...
	 * @param Miembro $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='miembro-form')
		{
    ...
    {
        return Yii::app()->basePath . '/../images/miembros/';
    }
}
